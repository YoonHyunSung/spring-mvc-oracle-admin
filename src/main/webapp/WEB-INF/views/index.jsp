...
<ol>
<li><a href="${ctx}/move/user/Delete">User Delete</a>
...
<ol>
<li><a href="${ctx}/move/book/Delete">Book Delete</a>
...
<ol>
<li><a href="${ctx}/move/publisher/Delete">Publisher Delete</a>
...
<ol>
<li><a href="${ctx}/move/order/Delete">Order Delete</a>
